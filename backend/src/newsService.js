...
const DEFAULT_FEEDS = [
  { name: 'G1 Musica', url: 'https://g1.globo.com/rss/g1/musica/' },
  ...
  { name: 'Metropoles Musica', url: 'https://www.metropoles.com/entretenimento/musica/feed' },
  { name: 'Terra Musica', url: 'https://www.terra.com.br/diversao/musica/rss.xml' },
];
...
const NEWS_TABLE = process.env.NEWS_TABLE || 'music_news';
const HEARTBEAT_TABLE = process.env.NEWS_HEARTBEAT_TABLE || 'collector_heartbeat';
const HEARTBEAT_KEY = process.env.NEWS_HEARTBEAT_KEY || 'retro_news';
